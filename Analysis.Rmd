...
ggplot(aes(x = nlcdClass, y = individualCount)) +
 +  geom_jitter(aes(color = nlcdClass), alpha = 0.01) +
 +  geom_boxplot(alpha = 0.5) +
 + scale_y_log10() +
 + ylab("Number of Mosquitos Captured") +
 + xlab("Vegetation Type") +
 + ggtitle("Vegetation Type vs Number of Mosquitos Captured")
