...
This figure looks at individual count from 2017 of the most abundant species. These six species are types of zooplakton collected throughout the seven sites. It looks at when the sample was taken at what month during the 2017 year, and its abundance at that time. The species of *Copepoda sp*, *Calanoida sp*, *Keratella taurocephala* seem to have a very consistent pattern of individual zooplankton present and when the sample was taken. The species of *Brachionus havanaensis*, *Bosmina longirostris*, and *Keratella quadrata* seem to fluctuate a lot throughout the 2017 year. 
...
My hypothesis was, Zooplankton at lower elevations (cooler temperatures) will have a higher abundance (individual count) than those at higher elevations (warmer temperatures).
Zooplankton are found in lakes and oceans all over the world. The seven NEON sites, Toolik (Tool), Barco Lake (BARC), Suggs Lake (SUGG), Prairie Lake at Dakota Coteau Field (PRLA), Prairie Pothole (PRPO), Crampton Lake (CRAM), and Little Rock Lake (LIRO) are lakes localized in four main locations as can be seen in Figure one. The most abundant species of zooplankton seem to come from the three sites of BARC, CRAM, and SUGG for the overall NEON dataset (Figure 2). This is due to the fact that both the BARC and SUGG site are located in FLordia, while the CRAM site is located in Wisconsin. The chemical composition and site location is a main component of the abundace of zooplankton. A study that looks at the relationships between zooplankton abundance and chlorophyll a concentrations in Florida lakes saw that this was a relationship. Abundances of the different groupings of zooplankton were positively correlated with chlorophyll a concentrations, with the most being in the summer [@canfield1984relationships]. Also both of these Flordia sites are highly influenced by rainwater and ground water interactions, which contributes to this zooplankton abundance. Zooplankton-trophic state relationships are also a significant factor. In a survey of eight lake systems located in north-central Florida, total zooplankton abundace showed a strong positive correlation (r2 = 0.87, p = 0.01) with trophic state [@blancher1984zooplankton]. Zooplankton abundace averaged about 1.0 x 10^5 m-2 in oligotrophic systems, which is what these two lakes are as mentioned above in the site descriptions. Also, the study mentioned that in these oligotrophic systems that abundance was relatively stable and this can be seen in Figure 2. The CRAM site is also categorized as a seepage lake charictorized by groundwater and rainwater. From this data and figure we can explain that zooplankton abundance is due to the type of lake it habitats and the chemical composition of the lake. 
